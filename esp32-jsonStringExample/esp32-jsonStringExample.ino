...
///////////////////////////////////////////
 ...
 Serial.println("Original Json Message:");
  ...
  Serial.println("Example: Get the nested element: obj1[\"properties\"][\"FW_VERSION\"][\"11.07.2019\"]");
  String sr = obj1["properties"]["FW_VERSION"]["11.07.2019"];
  Serial.println("sensor "+sr);
  //Get the nested element: Example
  Serial.println("Example: Get the nested element: obj1[\"properties\"][\"FW_VERSION\"]");  
  JsonObject obj2 = obj1["properties"]["FW_VERSION"];
  String sr2 = obj2["11.07.2019"];
  ...
  obj2["12.07.2019"] = "intermediate1 jan 0.7";
  String output2;
  ...
  JsonObject root1 = doc1.to<JsonObject>(); //root object filled with further json obejcts
  JsonObject propertyObject1  = root1.createNestedObject("properties");
  
  JsonObject firmwareObject1  = propertyObject1.createNestedObject("FW_VERSION");
  //slightly different structore here than usual, cause date (key) itsels is varying
  firmwareObject1["11.07.2019"] = "intermediate1 jan 0.5";
  firmwareObject1["10.07.2019"] = "intermediate jan 0.6";
...
output2 ="";
  ...
  root1 = doc1.to<JsonObject>();
  propertyObject1  = root1.createNestedObject("properties");
  firmwareObject1  = propertyObject1.createNestedObject("license");
  //slightly different structore here than usual, cause date (key) itsels is varying
  firmwareObject1["name"] = "CC BY 4.0";
  firmwareObject1["legal_notice"] = "Sajjad";
  firmwareObject1["url"] = "https://creativecommons.org/licenses/by/4.0/deed.de";
