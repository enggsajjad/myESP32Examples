  ...
  "<header id=\"luxbar\" class=\"luxbar-fixed\">"
    ...
    "<div class=\"luxbar-menu luxbar-menu-right luxbar-menu-material-bluegrey\">"
      "<ul class=\"luxbar-navigation\">"
        ...
        "</li>"
        "<li class=\"luxbar-item\"><a href=\"HOME_URI\">Konfiguration einrichten</a></li>"
        "<li class=\"luxbar-item\"><a href=\"" AUTOCONNECT_URI_CONFIG "\">Mit WiFi verbinden</a></li>"
        "<li class=\"luxbar-item\"><a href=\"" AUTOCONNECT_URI_DISCON "\">Aktuelle Verbindung trennen</a></li>"
        "<li class=\"luxbar-item\"><a href=\"" AUTOCONNECT_URI_UPDATE "\">Update</a></li>"
...
const char  AutoConnect::_PAGE_STAT[] PROGMEM = {
  ...
  "<title>AutoConnect statistics</title>"
    ...
    "</style>"
  "</head>"
  "<body style=\"padding-top:58px; padding-left:20px;\">"
  "<div class=\"container\">"
      "{{MENU_PRE}}"
      "{{MENU_AUX}}"
      "{{MENU_POST}}"
        ...
        "<br />"
        "<br />"
        "   (ggf. Menü-Button oben rechts drücken, um Menü auszuklappen)"
        "<br />"
        "<br />"
        "   1. Schritt: Mit WiFi verbinden"
        "<br />"
        "   2. Schritt: Konfiguration einrichten"
        "<br />"
        "<br />"
        "   Achtung: Nach Verbindung mit WiFi wird"
        "<br />"
        "   neu gestartet, und die Verbindung mit WiFi wird aufgebaut!"
        "<br />"
        "</div>"
    "</div>"
  "</body>"
  ...
  "<body style=\"padding-top:58px;\">"
    "<div class=\"container\">"
      ...
      "{{MENU_POST}}"
        ...
        "<br />"
        "<br />"
        "   Erfolgreich mit WiFi verbunden"
        "<br />"
        "   Verbindung zum Gerät nur noch über auf dem"
        "<br />"
        "   Display angezeigte IP."
        "<br />"
