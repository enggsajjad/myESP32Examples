...
#define AUTOCONNECT_MENULABEL_CONFIGNEW   "Configure1 new AP"
...
// This page for an example only, you can prepare the other for your application.
static const char AUX_AppPage2[] PROGMEM = R"(
{
  "title": "Hello Sajjad",
  "uri": "/sajjad",
  "menu": true,
...
WebServerClass  Server(HTTP_PORT);
...
void setup() {
  ...
  sajjad.load(AUX_AppPage2);

  portal.join({ hello, update, sajjad });
